export const colorSchemes: Record<string, { cssGradient: string; cssText: string; cssBorder: string }> = {
...
export const designStyles: Record<string, { cssGradient: string; borderRadius: string; shadow: string }> = {
